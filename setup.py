# -*- coding: utf-8 -*-
"""
Created on Sat Aug 20 22:50:32 2016
...
setup(
  name = 'sphere-kit',
  packages = ['sphere-kit'], # this must be the same as the name above
  version = '0.0',
  description = 'Computational tools for processing and analysis on hypersphere',
